...
import { ArrowRight, Heart, Linkedin, Instagram, Youtube, MessageCircle, Mail, ExternalLink, Coffee } from "lucide-react";
...
const Footer = () => {
  return (
    <footer className="py-16 px-4 border-t border-border/30 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-4 md:right-10 opacity-20 pointer-events-none">
        <div className="text-6xl md:text-8xl animate-float">🎄</div>
      </div>
      
      {/* Wreath decoration */}
      <div className="absolute top-4 left-4 md:left-10 opacity-20 pointer-events-none">
        ...
        <ScrollAnimation animation="fade-up" delay={200}>
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-border/30">
            ...
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <span>&</span>
              <div className="relative steam-container">
                <Coffee className="w-4 h-4 text-accent" />
                {/* Steam particles */}
                <div className="steam">
                  <div className="steam-particle" style={{ animationDelay: '0s', left: '-2px' }} />
                  <div className="steam-particle" style={{ animationDelay: '0.5s', left: '2px' }} />
                  <div className="steam-particle" style={{ animationDelay: '1s', left: '0px' }} />
                </div>
              </div>
